...
| [bvar-toolkit](https://github.com/joshuaccchan/bvar-toolkit) | `b8f702100e4be8e81175297d462f0eb38a3e274d` | `core/+bvar/+util/surform.m`, `tnormrnd.m`, `shaded_band.m`, `diffmat.m` | four of the seven bvar-toolkit functions that have code-identical twins in `core/+ssm/` |
| [bvar-toolkit](https://github.com/joshuaccchan/bvar-toolkit) | `e4123369515bed4e5cfd2400c7b26ff38b1fe948` | `core/+bvar/+sv/ksc_rw_h0.m`, `ksc_ar1_mean.m`, `ksc_rw_diffuse.m` | the twins of `ssm.ksc_rw_h0`, `ssm.ksc_ar1_mean` and `ssm.ksc_rw_diffuse`, pinned to the commit that corrected the comment on the draw of h in `ksc_rw_h0` |
