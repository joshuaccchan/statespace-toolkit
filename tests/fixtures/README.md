...
| [bvar-toolkit](https://github.com/joshuaccchan/bvar-toolkit) | `8d5c6c7625f1be19b27707c866c32319aaa86a23` | `core/+bvar/+sv/ksc_rw_h0.m`, `ksc_ar1_mean.m`, `ksc_rw_diffuse.m` | the twins of `ssm.ksc_rw_h0`, `ssm.ksc_ar1_mean` and `ssm.ksc_rw_diffuse`, pinned to the commit that corrected the spelling of "discrete" in the last two |
