...
| [bvar-toolkit](https://github.com/joshuaccchan/bvar-toolkit) | `b8f702100e4be8e81175297d462f0eb38a3e274d` | `core/+bvar/+util/surform.m`, `tnormrnd.m`, `shaded_band.m`, `diffmat.m`; `core/+bvar/+sv/ksc_rw_h0.m` | the five bvar-toolkit functions that have code-identical twins in `core/+ssm/` |
