...
| [bvar-toolkit](https://github.com/joshuaccchan/bvar-toolkit) | `947df3b4cf2a68cb4dda6bb8a97784d62c235915` | `core/+bvar/+util/surform.m`, `tnormrnd.m`, `shaded_band.m`, `diffmat.m`; `core/+bvar/+sv/ksc_rw_h0.m` | the five bvar-toolkit functions that have code-identical twins in `core/+ssm/` |
