% ssm.ksc_rw_h0 - KSC auxiliary-mixture sampler for the log-volatility path,
...
%
%   h = ssm.ksc_rw_h0(Ystar, h, sig, h0)
%
...
% stay so. The SVRW.m files in this repository are different samplers with
