% This script estimates the UC model with correlated errors and two breaks.
...
disp('Starting MCMC for UCUR-(t0,t1).... ');
disp(' ' );
start_time = clock; 
...
if cp_ml
    ...
    [ml,mlstd] = ml_UCUR_break2(y,store_theta,t0,t1,prior,M);
