...
%
% US real GDP, 1947Q1-2019Q4: the book's chapter09/UC_output_gap.m, with H2 and Hphi by
% ssm.lagpolymat and the means and draws of tau, phi and (tau_0, tau_{-1}) by
% ssm.simulate_states. phi is drawn from its Gaussian full conditional and kept when
% it is stationary, and sigtau2, under a uniform prior on (0, 0.01), by griddy Gibbs.
% The specification is similar to Grant and Chan (2017), with the AR(2) cycle of
% Morley, Nelson and Zivot (2003). For output gaps from published models,
% re-estimated every quarter, see trend-cycle-toolkit
% (github.com/joshuaccchan/trend-cycle-toolkit).
%
% See Chan (forthcoming), Section 9.1.3, for a textbook treatment.
%
% See:
